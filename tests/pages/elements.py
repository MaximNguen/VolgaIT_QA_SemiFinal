...
CHECKBOX1 = (By.XPATH, f"//input[@type='checkbox' and following-sibling::text()[contains(., 'drink1')]]")
CHECKBOX2 = (By.XPATH, f"//input[@type='checkbox' and following-sibling::text()[contains(., 'drink2')]]")
CHECKBOX3 = (By.XPATH, f"//input[@type='checkbox' and following-sibling::text()[contains(., 'drink3')]]")
CHECKBOX4 = (By.XPATH, f"//input[@type='checkbox' and following-sibling::text()[contains(., 'drink4')]]")
CHECKBOX5 = (By.XPATH, f"//input[@type='checkbox' and following-sibling::text()[contains(., 'drink5')]]")
CHECKBOX6 = (By.XPATH, f"//input[@type='checkbox' and following-sibling::text()[contains(., 'drink6')]]")
RADIO1 = (By.XPATH, f"//input[@type='radio' and following-sibling::text()[contains(., 'color3')]]")
